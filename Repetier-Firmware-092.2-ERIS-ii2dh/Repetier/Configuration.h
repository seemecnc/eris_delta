...
#define DELTA_MAX_RADIUS 65  //PRINTER_RADIUS-END_EFFECTOR_HORIZONTAL_OFFSET-CARRIAGE_HORIZONTAL_OFFSET
#define PRINTER_RADIUS 65
...
#define Z_PROBE_SENSITIVITY  27 // 0-126 7 bit value  
